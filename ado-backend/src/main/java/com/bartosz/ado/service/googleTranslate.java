...
public class googleTranslate {
    ...
    public Map<String, String> doTranslation(Map<String, Float> text){
        ...
        Translation translation = translate.translate(StringToMap(text),
                Translate.TranslateOption.sourceLanguage("en"),
                Translate.TranslateOption.targetLanguage("pl"));
        return MapToString(translation.getTranslatedText());
    }

    public String StringToMap (Map<String, Float> map){
    ...
    public Map<String, String> MapToString(String text){
